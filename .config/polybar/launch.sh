...
MONITOR=$PRIMARY TRAYPOS=center polybar --reload default-top & echo $! > $pidFile-$PRIMARY.pid
MONITOR=$PRIMARY TRAYPOS=center polybar --reload default-bottom & echo $! >> $pidFile-$PRIMARY.pid
